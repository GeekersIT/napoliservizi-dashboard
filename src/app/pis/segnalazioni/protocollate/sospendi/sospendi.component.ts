...
export class SegnalazioniProtocollateSospendiComponent extends SegnalazioneEdit implements OnInit {
    ...
    fieldGroup: [
      ...[{  
        ...
        expressionProperties: {
          'templateOptions.label': this._translateService.stream('Sospendi'),
        },
        fieldGroup: [{
          key: 'data',
          type: 'datepicker',
  ...
  async save(event:any){
    this._updateSegnalazioneGQL.mutate({
      ...
      segnalazione: {
        id: this.id,
        stato: _Stato_Segnalazione_Enum.Sospesa,
        eventi: {
          data: [
            {
