...
@Component({
  selector: 'app-ris-provvisori',
  templateUrl: './provvisori.component.html',
  styleUrls: ['./provvisori.component.scss'],
})
export class RisProvvisoriComponent implements OnInit {
  source: any;
