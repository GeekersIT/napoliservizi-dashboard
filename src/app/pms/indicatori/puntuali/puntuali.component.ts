...
import {
  DeleteFormulaGQL,
  IndicatoriPuntualiGQL,
  IndicatoriPuntualiSubscription,
} from 'src/app/_core/_services/generated/graphql';
import { EditComponent } from './edit/edit.component';

@Component({
  selector: 'app-puntuali',
  templateUrl: './puntuali.component.html',
  styleUrls: ['./puntuali.component.scss'],
})
export class PuntualiComponent implements OnInit {
  source: any;
  ...
  constructor(
    ...
    private _indicatoriPuntuali: IndicatoriPuntualiGQL,
  ...
  private _init() {
    return this._indicatoriPuntuali
      .subscribe()
      .subscribe(
        (response: SubscriptionResult<IndicatoriPuntualiSubscription>) => {
